...
//auto it0=b1.insert(5,static_cast<std::string>("CHIEF"));
//it0=b1.insert(3,static_cast<std::string>("l"));
//it0=b1.insert(10,static_cast<std::string>("r"));
//it0=b1.insert(6,static_cast<std::string>("rl"));
//it0=b1.insert(4,static_cast<std::string>("lr"));
//it0=b1.insert(1,static_cast<std::string>("ll"));
//it0=b1.insert(7,static_cast<std::string>("rlr"));
//it0=b1.insert(8,static_cast<std::string>("rlrr"));
//it0=b1.insert(9,static_cast<std::string>("rlrrr"));
//it0=b1.insert(14,static_cast<std::string>("rr"));
//it0=b1.insert(13,static_cast<std::string>("rrl"));
